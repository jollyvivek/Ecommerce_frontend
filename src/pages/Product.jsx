  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
         {/* product images */}
         <div className='flex flex flex-col-reverse gap-3 sm:flex-row'>
            <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll-none jusify-between sm:justify-normal sm:w-[19%] w-full'>
                  {productData.image.map((item,index)=>(
                     <img onClick={()=>setImage(item)} src={item} className='w-[24%] sm:w-full mb-3 flex-shrink-0 cursor-pointer' alt="" key={index} />
                  ))}
            </div>
      ...
      <div className='mt-20'>
         ...
         <div className='mt-0 flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
